...
BufferManager::BufferManager(bool storage_manager_truncate_mode) : storage_manager(storage_manager_truncate_mode),
...
SlottedPage &BufferManager::fix_page(int page_id)
{
    ...
    std::cout << "buffer manager fix_page: page_id is " << page_id << std::endl;
